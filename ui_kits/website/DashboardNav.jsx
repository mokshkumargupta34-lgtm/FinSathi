        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px", position: "relative" }}>
          ...
          {langOpen && (
            <div className="fsd-lang-panel">
              {FSD_LANGS.map((l) => (
                <button key={l.code} className="fsd-lang-item" data-active={l.code === lang.code} onClick={() => { setLang(l); setLangOpen(false); }}>
                  <span style={{ fontFamily: "var(--font-devanagari)", minWidth: "58px", textAlign: "left" }}>{l.label}</span>
